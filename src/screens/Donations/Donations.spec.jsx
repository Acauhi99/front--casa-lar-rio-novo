...
describe('Donations Component', () => {
  ...
  it('should display the inspirational quote', () => {
    render(<Donations />);
    expect(screen.getByText(/Toda doação é uma forma de amor/i)).toBeInTheDocument();
  });

  it('should render the donation description', () => {
    render(<Donations />);
    expect(screen.getByText(/As doações são muito importantes para o Asilo/i)).toBeInTheDocument();
  });
  ...
  it('should display the donation image', () => {
    ...
    expect(image).toHaveAttribute('src', expect.stringContaining('https://scontent'));
  });
  ...
  it('should render the donation button', () => {
    render(<Donations />);
    expect(screen.getByText(/Transforme sua generosidade em impacto/i)).toBeInTheDocument();
  });
  ...
  it('should render the newsletter section', () => {
    ...
    const subscribeButton = screen.getByRole('button', { name: /Inscreva-se/i });
